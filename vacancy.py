...
def vacancy_page():
    ...
    vacancy_ttl2 = tk.Label(vacancy_frame, text="Please enter the following data", font=my_font, fg="white",
                            bg="#3D5A80")
    ...
    req_qualification_lbl = tk.Label(vacancy_frame, text="Required Qualification", font=my_font0, fg="white",
                                     bg="#3D5A80")
    ...
    yrsOFexperience_lbl = tk.Label(vacancy_frame, text="Years of experience required", font=my_font0, fg="white",
                                   bg="#3D5A80")
    ...
    reqLanguage_lbl = tk.Label(vacancy_frame, text="Required Proficient Language", font=my_font0, fg="white",
                               bg="#3D5A80")
    ...
    def verify():
        ...
        if (a == "") or (b == "") or (c == "") or (d == "") or (e == "") or (f == "") or (g == "") or (h == "") or (
                i == "") or (j == ""):
...
#data for post 1---
    ...
    # labels----
    coname_l = Label(board, text=f"Company name:{cname}", font=my_font1, bg="#2B2828", fg="white")
    ...
    co_de = Label(post1, text=f"Field of work:", font=my_font1, bg="#2B2828", fg="white")
    co_de.place(x=10, y =20)
    co_de1 = Label(post1, text=f"{fw}", font=my_font1, bg="#2B2828", fg="white")
    co_de1.place(x=10, y=60)
    co_de2 = Label(post1, text=f"Required skills:", font=my_font1, bg="#2B2828", fg="white")
    co_de2.place(x=10, y=100)
    co_de3 = Label(post1, text=f"{rs}", font=my_font1, bg="#2B2828", fg="white")
    co_de3.place(x=10, y=140)
    co_de4 = Label(post1, text=f"Required qualification:", font=my_font1, bg="#2B2828", fg="white")
    co_de4.place(x=10, y=180)
    co_de5 = Label(post1, text=f"{rq}", font=my_font1, bg="#2B2828", fg="white")
    co_de5.place(x=10, y=220)
    ...
    co_de = Label(post2, text=f"Field of work:", font=my_font1, bg="#2B2828", fg="white")
    co_de.place(x=10, y=20)
    co_de1 = Label(post2, text=f"{fw1}", font=my_font1, bg="#2B2828", fg="white")
    co_de1.place(x=10, y=60)
    co_de2 = Label(post2, text=f"Required skills:", font=my_font1, bg="#2B2828", fg="white")
    co_de2.place(x=10, y=100)
    co_de3 = Label(post2, text=f"{rs1}", font=my_font1, bg="#2B2828", fg="white")
    co_de3.place(x=10, y=140)
    co_de4 = Label(post2, text=f"Required qualification:", font=my_font1, bg="#2B2828", fg="white")
    co_de4.place(x=10, y=180)
    co_de5 = Label(post2, text=f"{rq1}", font=my_font1, bg="#2B2828", fg="white")
    co_de5.place(x=10, y=220)

    # edit button
    edit_btn = Button(profile_p, text='EDIT', font=my_font1, bg="#FCA311", fg="black", command=edit)

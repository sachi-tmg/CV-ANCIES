...
#buttons--------------------------------------------
about_btn=Button(bar,text="ABOUT",bg="#213A5C",fg="white",padx=73.2,pady=4,font=my_font,command=lambda:indicate(about_indicate,about_p))
...
vacancy_btn=Button(bar,text="VACANCY FORM",bg="#213A5C",fg="white",padx=31.4,font=my_font,pady=4,command=lambda:indicate(vacancy_indicate,vacancy_page))
vacancy_btn.place(y=375,x=0)

profile_btn=Button(bar,text="PROFILE",bg="#213A5C",fg="white",padx=67,font=my_font,pady=4,command=lambda:indicate(profile_indicate,profile))
...
def vacancy_page():
    ...
    vacancy_ttl2=tk.Label(vacancy_frame,text="Please enter the following data",font=my_font ,fg="white",bg="#3D5A80")
    ...
    #insert into tables
        log1.execute("INSERT INTO details VALUES(:name, :address, :language, :field, :skills, :salary, :contact, :qualification, :anything_else, :email, :yearOfExperience)", {
